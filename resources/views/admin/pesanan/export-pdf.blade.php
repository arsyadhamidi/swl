...
<body>
    <div class="header">
        ...
        <div class="text"
            ...
            <p>Laporan Data Pesanan Terdaftar</p>
        </div>
    </div>
    ...
    <div class="table-container">
        <table>
            <thead>
                <tr>
                    <th colspan="7">LAPORAN DATA PESANAN</th>
                </tr>
                <tr>
                    <th style="width: 4%;">No.</th>
                    <th style="text-align: left;">Nama</th>
                    <th style="text-align: left;">Tanggal</th>
                    <th style="text-align: left;">Tot.Harga</th>
            ...
            <tbody>
                @foreach ($pesanans as $data)
                    <tr>
                        ...
                        <td style="text-align: left;">{{ $data->tgl_pesanan ?? '-' }}</td>
                        <td style="text-align: left;">
                            {{ $data->tot_harga ? 'Rp ' . number_format($data->tot_harga, 0, ',', '.') : '-' }}
                        </td>
                        <td style="text-align: left;">{{ $data->alamat_pengiriman ?? '-' }}</td>
